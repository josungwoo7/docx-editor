...
import { i as TableAction, a as TranslationKey, P as ParsedClipboardContent } from './clipboard-BnTQ1BBf.mjs';
export { e as PrintButton, f as PrintButtonProps, g as PrintOptions, h as PrintStyles, j as TableContext, k as TableSelection, l as TableSplitConfig, m as TableToolbar, n as TableToolbarProps, o as addColumn, p as addRow, u as createTableContext, v as deleteColumn, w as deleteRow, x as formatPrintPageRange, y as getCellAt, z as getColumnCount, A as getDefaultPrintOptions, B as getTableSplitCellDialogConfig, G as isPrintSupported, J as mergeCells, K as openPrintWindow, O as parsePageRange, S as splitCell, U as splitTableCell, V as triggerPrint } from './clipboard-BnTQ1BBf.mjs';
